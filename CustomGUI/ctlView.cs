...
namespace UV_DLP_3D_Printer.GUI.CustomGUI
{
    public partial class ctlView : ctlUserPanel
    {
        ...
        public ctlView()
        {
            ...
            #else
            buttBoundingBox.Checked = false;
            buttSelOutline.Checked = false;
            buttShowConsole.Checked = false;
            buttSelOutline.Visible = false;
            buttShowConsole.Visible = false;
            #endif
        }
        ...
        private void buttShowSlice_Click(object sender, EventArgs e)
        {
            ...
            // now save it
            UVDLPApp.Instance().m_appconfig.Save(UVDLPApp.Instance().GetConfigFolder() + UVDLPApp.m_pathsep + UVDLPApp.m_appconfigname);            
