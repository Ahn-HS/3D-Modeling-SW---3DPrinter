    ...
    public partial class ctlScale : ctlUserPanel
    {
        ...
        protected void ScaleObject(ctlTextBox var, float x, float y, float z)
        {
            try
            {
                ...
                //by sypark 2016-02-11
                float scalemin = UVDLPApp.Instance().SelectedObject.m_min.z;
                ...
                float calscalemin = (float)UVDLPApp.Instance().SelectedObject.m_min.z - scalemin;
                UVDLPApp.Instance().SelectedObject.Translate(0, 0, -calscalemin, true);
        ...
        private void ctlTitle1_Click(object sender, EventArgs e)
        {
            if (ctlTitle1.Checked)
            {
                ...
                //sky(hide) h += flowLayoutPanel2.Height;
        ...
        private void ctlScale_Resize(object sender, EventArgs e)
        {
            try
            {
                ...
                //sky(hide) flowLayoutPanel2.Width = flowLayoutPanel2.Parent.Width - 6;
